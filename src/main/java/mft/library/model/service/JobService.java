...
public class JobService {
    ...
    public static void save(JobHistory jobHistory) throws Exception {
        if (!(jobHistory.getStartDate().getYear() >= 1980 && jobHistory.getEndDate().getYear() <= 2020)) {
...
//        }
    ...
    public static List<JobHistory> findByNameAndJob(String person, String job) throws Exception {
        try (JobRepository jobRepository = new JobRepository()) {
